...
args="${1}";
  	case "$( echo ${args} | tr '[:upper:]' '[:lower:]' )" in
		...
		-s|--speed|--small)
			...
			echo "———————————————————————— $2 SUBDOMAIN—————————————————————————————————"
			cat crt_$2.txt warchive_$2.txt dnsbuffer_$2.txt threatcrowd_$2.txt hackertarget_$2.txt certspotter_$2.txt anubisdb_$2.txt virustotal_$2.txt alienvault_$2.txt urlscan_$2.txt threatminer_$2.txt entrust_$2.txt riddler_$2.txt dnsdumper_$2.txt rapiddns_$2.txt |sort -u|egrep -v "//|:|,| |_|\|@" |grep -o "\w.*$2"|tee no_resolve_$2.txt
		...
		-a|--all)
			...
			echo "———————————————————————— $2 SUBDOMAIN—————————————————————————————————"
			cat crt_$2.txt warchive_$2.txt dnsbuffer_$2.txt threatcrowd_$2.txt hackertarget_$2.txt certspotter_$2.txt anubisdb_$2.txt virustotal_$2.txt alienvault_$2.txt urlscan_$2.txt threatminer_$2.txt entrust_$2.txt riddler_$2.txt dnsdumper_$2.txt findomain_$2.txt subfinder_$2.txt amass_$2.txt assetfinder_$2.txt rapiddns_$2.txt | sort -u|egrep -v "//|:|,| |_|\|@" |grep -o "\w.*$2"|tee no_resolve_$2.txt
